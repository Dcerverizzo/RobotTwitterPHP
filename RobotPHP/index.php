...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="Request.php?class=app\controller\AppCtr&method=showView">Serviços</a>
                        </li>
                        <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>SION My Robot Twitter</h1>
                    <p>Click on tab Services for use SION</p>
                    <form class="form-horizontal" method="post" action="app/controller/robot.php">
                        ...
                        <div class="form-group"> 
                            <div class="col-sm-offset-2 col-sm-10">
                                <div class="checkbox">
                                    <label><input name="follow" id="follow" type="checkbox">Auto Follow</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group"> 
                            <div class="col-sm-offset-2 col-sm-10">
                                <div class="checkbox">
                                    <label><input name="unfollow" id="unfollow" type="checkbox">Auto unfollow</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group"> 
